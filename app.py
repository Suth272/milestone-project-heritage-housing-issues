...
from app_pages.house_sale_price_ui import house_sale_price_ui
from app_pages.ml_house_sale_price import ml_house_sale_price
...
app.add_page("House Sale Price UI", house_sale_price_ui)
app.add_page("ML: House Sale Price", ml_house_sale_price)
